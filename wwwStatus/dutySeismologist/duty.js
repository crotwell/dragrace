...
let today = moment()
  if(today.weekday() === 5){
    ...
    classList=['SATURDAY','Sportsman-Eliminations','Midway-Open','Competition-Eliminator','Super-Comp','Top-Alcohol-Qualifying-Session','Factory-Stock-Showdown-Qualifying','Mountain-Motor-Pro-Stock-Qualifying-Session','Pro-Mod-Qualifying-Session','Pro-Stock-Motorcycle-Qualifying-Session','Nitro-Qualifying-Session','Top-Alcohol-Eliminations','Factory-Stock-Showdown','Pro-Mod-Qualifying-Session','Pro-Stock-Motorcycle-Qualifying-Session','Nitro-Qualifying-Session','Mountain Motor-Pro-Stock-Qualifying-////Session','Top-Alcohol-Eliminations','Secure-Track'];
